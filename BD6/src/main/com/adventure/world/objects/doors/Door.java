...
public class Door implements Tangible {
    ...
    /**
     * Door constructor is listed as not open on level 1.
     */
    public Door() {
        level = 1;
        isOpen = false;
    ...
    /**
     *
     * @param isOpen lets the user know whether or not the door is open
     * @param level lets the user know which level they are currently on
     */
