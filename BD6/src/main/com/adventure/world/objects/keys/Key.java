...
public class Key implements Tangible {
    ...
    /**
     * Key overloaded constructor that takes in the level and gives the level and the name.
     * @param level Lets the user know which level they are on.
     */
    ...
    /**
     * Key overloaded constructor.
     * @param level level is provided by the user.
     * @param name name is also provided by the user.
     */
